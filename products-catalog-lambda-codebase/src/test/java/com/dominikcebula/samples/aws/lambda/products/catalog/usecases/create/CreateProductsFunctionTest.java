...
class CreateProductsFunctionTest {
    @Autowired
    private CreateProductFunction underTest;
    @Autowired
    ...
    @ParameterizedTest
    @Event(value = "events/create-product.json", type = APIGatewayProxyRequestEvent.class)
    void shouldCreateProduct(APIGatewayProxyRequestEvent requestEvent) throws JsonProcessingException {
